...
func init() {
	...
	PanicCmd.Flags().StringVarP(&panicStatus, "status", "s", "", "status you want to set the your feature experimentation environment. Only 2 values are possible: on and off")
