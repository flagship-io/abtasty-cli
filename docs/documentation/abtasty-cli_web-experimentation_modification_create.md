...
```
abtasty-cli web-experimentation modification create [--variation-id=<variation-id>] [-d <data-raw> | --data-raw=<data-raw>] [flags]
```
...
```
  ...
  -h, --help               help for create
      --variation-id int   variation id of your modifications
```
