...
hide:
  - navigation
---
## abtasty-cli web-experimentation folder get
...
```
abtasty-cli web-experimentation folder get [-i <folder-id> | --id <folder-id>] [flags]
```
...
```
  -h, --help     help for get
  -i, --id int   id of the folder you want to display
```
